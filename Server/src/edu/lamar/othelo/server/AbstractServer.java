...
public abstract class AbstractServer implements Runnable
{
	...
	final synchronized public void close() throws IOException
	{
		...
		finally
		{
			...
			final Thread[] clientThreadList = getClientConnections();
	 ...
	 */
	public void sendToAllClients(final Object msg)
	{
		final Thread[] clientThreadList = getClientConnections();
	...
	{
		final Thread[] clientThreadList = new
	 ...
	 */
	final public void setTimeout(final int timeout)
	{
	 ...
	 */
	final public void setBacklog(final int backlog)
	{
	...
	synchronized protected void clientException(
			final ConnectionToClient client, final Throwable exception) {}
	 ...
	 */
	protected void listeningException(final Throwable exception) {}
	...
	final synchronized void receiveMessageFromClient(
			final Object msg, final ConnectionToClient client)
	{
