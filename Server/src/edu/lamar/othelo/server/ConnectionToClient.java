...
public class ConnectionToClient extends Thread {
	 ...
	 */
	ConnectionToClient(final ThreadGroup group, final Socket clientSocket,
			final AbstractServer server) throws IOException {
	 ...
	 */
	final public void sendToClient(final Object msg) throws IOException {
	...
	/**
	 * Reset the output stream so we can use the same buffer repeatedly. This
	 * would not normally be used, but is necessary in some circumstances when
	 * Java refuses to send data that it thinks has been sent.
	 */
